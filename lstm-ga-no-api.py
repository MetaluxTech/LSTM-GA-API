...
def predict_resource_requirements(datacenter):
    ...
    storage_tb = datacenter['Available Resources']['StorageTB']
...
# Run the Genetic Algorithm with a budget constraint to find the best datacenter
budget = 2500  # Set your budget constraint
best_datacenter = genetic_algorithm(datacenters, generations=100, budget=budget)

# Print the best datacenter to connect to
print("Best Datacenter to Connect to:")
print(best_datacenter)